...
alter table DYEXTN_ATTRIBUTE drop foreign key FK37F1E2FF42E8975D;
...
alter table DYEXTN_FLOAT_TYPE_INFO add index FK7E1C0693BC7298A9 (IDENTIFIER), add constraint FK7E1C0693BC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO (IDENTIFIER);
...
alter table DYEXTN_INTEGER_TYPE_INFO add index FK5F9CB235BC7298A9 (IDENTIFIER), add constraint FK5F9CB235BC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO (IDENTIFIER);
...
alter table DYEXTN_COMBOBOX add index FKABBC649ABC7298A9 (IDENTIFIER), add constraint FKABBC649ABC7298A9 foreign key (IDENTIFIER) references DYEXTN_CONTROL (IDENTIFIER);
...
alter table DYEXTN_DOUBLE_TYPE_INFO add index FKC83869C2BC7298A9 (IDENTIFIER), add constraint FKC83869C2BC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO (IDENTIFIER);
...
alter table DYEXTN_LONG_TYPE_INFO add index FK257281EDBC7298A9 (IDENTIFIER), add constraint FK257281EDBC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO (IDENTIFIER);
...
alter table DYEXTN_LIST_BOX add index FK208395A7BC7298A9 (IDENTIFIER), add constraint FK208395A7BC7298A9 foreign key (IDENTIFIER) references DYEXTN_CONTROL (IDENTIFIER);
...
alter table DYEXTN_ATTRIBUTE add index FK37F1E2FF42E8975D (CONTROL_ID), add constraint FK37F1E2FF42E8975D foreign key (CONTROL_ID) references DYEXTN_CONTROL (IDENTIFIER);
...
alter table DYEXTN_SHORT_TYPE_INFO add index FK99540B3BC7298A9 (IDENTIFIER), add constraint FK99540B3BC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO (IDENTIFIER);
