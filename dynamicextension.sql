...
alter table DYEXTN_COLLECTION_ATTR_RECORD drop constraint FK6C88AA9B79F466F7;
alter table DYEXTN_COLLECTION_ATTR_RECORD drop constraint FK6C88AA9B4D87D1BE;
...
drop table DYEXTN_COLLECTION_ATTR_RECORD cascade constraints;
...
drop sequence DE_COLLECTION_ATTR_REC_SEQ;
...
create table DYEXTN_COLLECTION_ATTR_RECORD (
   IDENTIFIER number(19,0) not null,
   ENTITY_ID number(19,0),
   ATTRIBUTE_ID number(19,0),
...
alter table DYEXTN_COMBOBOX add constraint FKABBC649ABC7298A9 foreign key (IDENTIFIER) references DYEXTN_CONTROL;
...
alter table DYEXTN_DOUBLE_TYPE_INFO add constraint FKC83869C2BC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO;
...
alter table DYEXTN_LONG_TYPE_INFO add constraint FK257281EDBC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO;
...
alter table DYEXTN_COLLECTION_ATTR_RECORD add constraint FK6C88AA9B79F466F7 foreign key (ENTITY_ID) references DYEXTN_ENTITY;
alter table DYEXTN_COLLECTION_ATTR_RECORD add constraint FK6C88AA9B4D87D1BE foreign key (ATTRIBUTE_ID) references DYEXTN_PRIMITIVE_ATTRIBUTE;
...
alter table DE_COLL_ATTR_RECORD_VALUES add constraint FK847DA577355836BC foreign key (COLLECTION_ATTR_RECORD_ID) references DYEXTN_COLLECTION_ATTR_RECORD;
alter table DYEXTN_SHORT_TYPE_INFO add constraint FK99540B3BC7298A9 foreign key (IDENTIFIER) references DYEXTN_ATTRIBUTE_TYPE_INFO;
...
create sequence DE_COLLECTION_ATTR_REC_SEQ;
