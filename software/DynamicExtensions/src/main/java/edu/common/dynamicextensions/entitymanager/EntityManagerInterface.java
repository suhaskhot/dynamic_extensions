...
public interface EntityManagerInterface
{
	 ...
	 */
	Long insertData(EntityInterface entity, Map<AbstractAttributeInterface, Object> dataValue,
			HibernateDAO hibernateDao, List<FileQueryBean> fileRecordQueryList,
	 ...
	 * @param associationInterface the association interface
	 * @param sourceEntityRecordId the source entity record id
	 * @param TargetEntityRecordId the target entity record id
