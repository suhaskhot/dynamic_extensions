...
create table DYEXTN_CONTROL (IDENTIFIER bigint generated by default as identity, CAPTION varchar(800), CSS_CLASS varchar(255), HIDDEN smallint, NAME varchar(255), SEQUENCE_NUMBER integer, TOOLTIP varchar(255), CONTAINER_ID bigint, BASE_ABST_ATR_ID bigint, READ_ONLY smallint, HEADING varchar(255), primary key (IDENTIFIER));
