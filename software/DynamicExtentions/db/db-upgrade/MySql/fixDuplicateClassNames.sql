...
BEGIN
   ...
   DECLARE	cursor cur1  IS (select meta12.name,meta12.identifier from dyextn_association as11 join dyextn_attribute att11 on att11.identifier = as11.identifier
