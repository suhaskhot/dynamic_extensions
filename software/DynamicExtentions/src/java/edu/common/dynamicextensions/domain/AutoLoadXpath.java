...
public class AutoLoadXpath implements Serializable
{
	...
	public AutoLoadXpath(AutoLoadXpath autoLoadXpath)
	{
		this.xpath = autoLoadXpath.getXpath();
		for(String cc: autoLoadXpath.getConceptCodeCollection())
		{
			this.conceptCodeCollection.add(cc);
		}
	}

	public AutoLoadXpath()
	{
		super();
	}
