			...
			AttributeMetadataInterface
{
	...
	public CategoryAttribute(CategoryAttributeInterface attribute, CategoryEntity categoryEntity2) throws DynamicExtensionsSystemException
	{
		super((CategoryAttribute) attribute);
		copyCategoryAttribute(attribute,this, categoryEntity2);
	
	}

	private void copyCategoryAttribute(CategoryAttributeInterface attribute,
			CategoryAttribute copyAttribute, CategoryEntity categoryEntity2) throws DynamicExtensionsSystemException
	{
		copyAttribute.abstractAttribute = attribute.getAbstractAttribute();
		copyAttribute.isCalculated = attribute.getIsCalculated();
		copyAttribute.isPopulateFromXml = attribute.getIsPopulateFromXml();
		copyAttribute.isRelatedAttribute = attribute.getIsRelatedAttribute();
		copyAttribute.isSkipLogic = attribute.getIsSkipLogic();
		copyAttribute.isSourceForCalculatedAttribute = attribute.getIsSourceForCalculatedAttribute();
		copyAttribute.isVisible = attribute.getIsVisible();

		if(attribute.getDefaultSkipLogicValue() != null)
		{
			copyAttribute.defaultSkipLogicValue = PermissibleValueUtility.copy(attribute.getDefaultSkipLogicValue());	
		}
		if(!attribute.getSkipLogicPermissibleValues().isEmpty())
		{
			for(PermissibleValueInterface permissibleValue:attribute.getSkipLogicPermissibleValues())
			{
				copyAttribute.skipLogicpermissibleValuesCollection.add(PermissibleValueUtility.copy(permissibleValue));
			}
		}
		if(!attribute.getCalculatedCategoryAttributeCollection().isEmpty())
		{
			for(CalculatedAttributeInterface categoryAttribute: attribute.getCalculatedCategoryAttributeCollection())
			{
				CalculatedAttribute calculatedAttribute = new CalculatedAttribute();
				
				CategoryAttributeInterface calCA = categoryEntity2.getAttributeByName(((CategoryAttribute)categoryAttribute.getCalculatedAttribute()).getName()) ;
				calCA = getCategoryAttibute(categoryEntity2, categoryAttribute.getCalculatedAttribute(), calCA);
				calculatedAttribute.setCalculatedAttribute(calCA);
				
				CategoryAttributeInterface sourceCalCA =categoryEntity2.getAttributeByName(((CategoryAttribute)categoryAttribute.getSourceForCalculatedAttribute()).getName()) ; 
				sourceCalCA = getCategoryAttibute(categoryEntity2, categoryAttribute.getSourceForCalculatedAttribute(), sourceCalCA);
				calculatedAttribute.setSourceForCalculatedAttribute(sourceCalCA);
				
				copyAttribute.calculatedCategoryAttributeCollection.add(calculatedAttribute);
			}
		}
		if(!attribute.getCalculatedAttributeCollection().isEmpty())
		{
			for(CategoryAttributeInterface categoryAttribute: attribute.getCalculatedAttributeCollection())
			{
				CategoryAttributeInterface ca = getCategoryAttibute(categoryEntity2, categoryAttribute, categoryEntity2
						.getAttributeByEntityAttributeName(categoryAttribute.getName()));
				/*if(ca == null)
				{
					ca = new CategoryAttribute(categoryAttribute, categoryEntity2);
					categoryEntity2.getCategoryAttributeCollection().add(categoryAttribute);	
					ca.setCategoryEntity(categoryEntity2);
				}*/
				copyAttribute.calculatedAttributeCollection.add(ca);
			}
		}
		CategoryAttribute categoryAttributeTemp = (CategoryAttribute)attribute;
		if(!categoryAttributeTemp.getCalculatedDependentCategoryAttributes().isEmpty())
		{
			for(CategoryAttributeInterface categoryAttribute: categoryAttributeTemp.getCalculatedDependentCategoryAttributes())
			{
				CategoryAttributeInterface ca = getCategoryAttibute(categoryEntity2, categoryAttribute, categoryEntity2
						.getAttributeByEntityAttributeName(categoryAttribute.getName()));
				/*if(ca == null)
				{
					ca = new CategoryAttribute(categoryAttribute, categoryEntity2);
					categoryEntity2.getCategoryAttributeCollection().add(ca);	
					ca.setCategoryEntity(categoryEntity2);
				}*/
				copyAttribute.calculatedDependentCategoryAttributes.add(ca);
			}
		}
		
		if(!categoryAttributeTemp.getDependentSkipLogicAttributes().isEmpty())
		{
			for(SkipLogicAttributeInterface skipLogicAttribute: categoryAttributeTemp.getDependentSkipLogicAttributes())
			{
				CategoryAttributeInterface sourceCa =getCategoryAttibute(categoryEntity2, skipLogicAttribute.getSourceSkipLogicAttribute(), categoryEntity2
						.getAttributeByEntityAttributeName(skipLogicAttribute.getSourceSkipLogicAttribute().getName())) ;
				/*if(sourceCa == null)
				{
					sourceCa = new CategoryAttribute(skipLogicAttribute.getSourceSkipLogicAttribute(), categoryEntity2);
					categoryEntity2.getCategoryAttributeCollection().add(sourceCa);	
					sourceCa.setCategoryEntity(categoryEntity2);
				}
				*/
				CategoryAttributeInterface targetCa = getCategoryAttibute(categoryEntity2,
						skipLogicAttribute.getTargetSkipLogicAttribute(),
						categoryEntity2.getAttributeByEntityAttributeName(skipLogicAttribute
								.getTargetSkipLogicAttribute().getName()));
				/*if(targetCa == null)
				{
					targetCa = new CategoryAttribute(skipLogicAttribute.getSourceSkipLogicAttribute(), categoryEntity2);
					categoryEntity2.getCategoryAttributeCollection().add(targetCa);	
					targetCa.setCategoryEntity(categoryEntity2);
				}*/
				SkipLogicAttribute skipLogicAttribute2 = new SkipLogicAttribute((SkipLogicAttribute) skipLogicAttribute);
				skipLogicAttribute2.setSourceSkipLogicAttribute(sourceCa);
				skipLogicAttribute2.setTargetSkipLogicAttribute(targetCa);
				copyAttribute.dependentSkipLogicAttributes.add(skipLogicAttribute2);
			}
		}
		/*
		copyAttribute.dependentSkipLogicAttributes
*/
		if(attribute.getFormula() != null)
		{
			copyAttribute.formulaCollection.add(new Formula(attribute.getFormula()));
		}
		if(!attribute.getDataElementCollection().isEmpty())
		{
			
			for(DataElementInterface dataElement: attribute.getDataElementCollection())
			{
				copyAttribute.dataElementCollection.add(new UserDefinedDE((UserDefinedDE)dataElement));
			}
		}
		
		if(attribute.getDefaultValuePermissibleValue() != null)
		{
			copyAttribute.defaultPermissibleValuesCollection.add(PermissibleValueUtility.copy(attribute.getDefaultValuePermissibleValue()));
		}
		if(!attribute.getRuleCollection().isEmpty())
		{
			for(RuleInterface rule: attribute.getRuleCollection())
			{
				copyAttribute.ruleCollection.add(new Rule((Rule) rule));
			}
		}
	}

	private CategoryAttributeInterface getCategoryAttibute(CategoryEntity copyCatEnt,
			CategoryAttributeInterface sourceCA, CategoryAttributeInterface copyAttribute) throws DynamicExtensionsSystemException
	{
		if(copyAttribute == null)
		{
			copyAttribute = new CategoryAttribute();
			copyAbstractMetadata((AbstractMetadata) sourceCA,(AbstractMetadata) copyAttribute);
			copyCatEnt.getCategoryAttributeCollection().add(copyAttribute);	
			copyAttribute.setCategoryEntity(copyCatEnt);
			
			copyCategoryAttribute(sourceCA,(CategoryAttribute) copyAttribute, copyCatEnt);
