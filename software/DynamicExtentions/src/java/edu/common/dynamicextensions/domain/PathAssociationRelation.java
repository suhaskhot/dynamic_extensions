			...
			Comparable
{
	...
	public PathAssociationRelation(PathAssociationRelationInterface associationRelation)
	{
		this.association = (Association) associationRelation.getAssociation();
		this.pathSequenceNumber = associationRelation.getPathSequenceNumber();
		this.sourceInstanceId = associationRelation.getSourceInstanceId();
		this.targetInstanceId = associationRelation.getTargetInstanceId();
	}
