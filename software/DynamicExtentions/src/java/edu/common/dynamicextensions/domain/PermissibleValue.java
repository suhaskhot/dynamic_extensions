		...
		implements PermissibleValueInterface, Comparator<PermissibleValue>
{
	...
	public PermissibleValue(PermissibleValue defaultValuePermissibleValue) throws DynamicExtensionsSystemException
	{
		this.setNumericCode(defaultValuePermissibleValue.getNumericCode());
		try
		{
			this.setObjectValue(defaultValuePermissibleValue.getValueAsObject());
		}
		catch (ParseException e)
		{
			throw new DynamicExtensionsSystemException("Error creating PV copy", e);
		}
		for(SemanticPropertyInterface semanticProperty: defaultValuePermissibleValue.getSemanticPropertyCollection() )
		{
			this.getSemanticPropertyCollection().add(new SemanticProperty(semanticProperty));
		}
	}
