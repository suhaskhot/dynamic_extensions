...
public class ListBox extends SelectControl implements ListBoxInterface
{
	...
	public ListBox(ListBox control)
	{
		super(control);
		control.isMultiSelect = control.getIsMultiSelect();
		this.IsUsingAutoCompleteDropdown =control.getIsUsingAutoCompleteDropdown();
		this.noOfRows = control.getNoOfRows();
	}
}