...
public class Rule extends DynamicExtensionBaseDomainObject implements RuleInterface
{
	...
	public Rule(Rule rule)
	{
		...
		if(!rule.getRuleParameterCollection().isEmpty())
		{
			for(RuleParameterInterface parameter: rule.getRuleParameterCollection())
			{
				this.ruleParameterCollection.add(new RuleParameter((RuleParameter) parameter));	
			}
