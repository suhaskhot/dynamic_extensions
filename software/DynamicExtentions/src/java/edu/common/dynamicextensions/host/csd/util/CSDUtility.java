...
public class CSDUtility
{
	...
	@SuppressWarnings("unchecked")
	public static Collection getSelectedCategoryInfo(Map<String, NamedQueryParam> param) throws DynamicExtensionsSystemException
	{
		Collection categoryDetails = AbstractBaseMetadataManager.executeHQL("getSelectedCategoryInfo",param);
		return categoryDetails;
	}
}