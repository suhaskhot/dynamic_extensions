...
public class CreateFormClient extends AbstractClient {
	private static final Logger logger = Logger.getLogger(CreateFormClient.class);

	public static void main(String[] args) 
	{		
		Variables.serverUrl = args[0];
		CreateFormClient createFormClient = new CreateFormClient();
	...
	//
	// TODO: Check whether we really need this code?
	//	
