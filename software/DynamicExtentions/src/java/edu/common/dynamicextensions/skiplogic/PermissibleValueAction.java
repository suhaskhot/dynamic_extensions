...
public class PermissibleValueAction implements Action
{
	...
	public PermissibleValueAction()
	{
		
	}
	
	public PermissibleValueAction(PermissibleValueAction action) throws DynamicExtensionsSystemException
	{
		this.defaultValue = PermissibleValueUtility.copy(action.getDefaultValue());
		this.listOfPermissibleValues = new HashSet<PermissibleValueInterface>();
