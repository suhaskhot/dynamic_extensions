...
public class PrimitiveCondition implements Condition
{
    ...
    public PrimitiveCondition(PrimitiveCondition sourceCondition) throws DynamicExtensionsSystemException
    {
    	this.condValue = sourceCondition.getValue();
    	this.objectValue = sourceCondition.getObjectValue();
    	this.relationalOperator = sourceCondition.relationalOperator;
    }
    /**
    * Check condition.
