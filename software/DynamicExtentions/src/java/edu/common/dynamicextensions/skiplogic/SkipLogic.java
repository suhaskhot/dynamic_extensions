...
public class SkipLogic
{
	...
	public SkipLogic(SkipLogic skipLogic,ContainerInterface sourceContainer,CategoryInterface category) throws DynamicExtensionsSystemException
	{
		
		this.containerIdentifier = sourceContainer.getId();
		this.listOfconditionStatements = new ArrayList<ConditionStatements>();
		for (ConditionStatements conditionStatements : skipLogic.getListOfconditionStatements())
		{
			this.listOfconditionStatements.add(new ConditionStatements(conditionStatements,
					conditionStatements.getControlIdentifier(), sourceContainer, category));
		}
	}
	/**
	 * Sets the identifier.
