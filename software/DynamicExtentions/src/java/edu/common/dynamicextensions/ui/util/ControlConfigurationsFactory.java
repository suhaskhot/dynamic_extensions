...
import edu.common.dynamicextensions.nvalidator.RuleValidator;
...
public final class ControlConfigurationsFactory
{
	...
	private Object initialize(String xsdFileName, String xmlFileName, String packageName)
	{
		...
		catch (JAXBException e)
		{
			...
			throw new RuntimeException(ApplicationProperties.getValue(""), e);
		}
	 ...
	 */
	private void loadControlConfigurations()
	{
	 ...
	 */
	public RuleValidator getValidatorRule(String ruleName)
	{
		...
		try
		{
			...
			return (RuleValidator) ruleClass.newInstance();
		}
		catch (Exception e)
		{
