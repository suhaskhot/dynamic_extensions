...
public class CategoryPreprocessor
{
	 ...
	 *
	 */
	public CategoryPreprocessorResult processCategories(IQuery query) throws DynamicExtensionsCacheException
	{
		clear();
		this.query = query;
	...
	private void processCategories() throws DynamicExtensionsCacheException
	{
	...
	private void processCategoryExpression(IExpression expr) throws DynamicExtensionsCacheException
	{
	...
	protected Category getCategoryFromEntity(EntityInterface catEntity) throws DynamicExtensionsCacheException
	{
