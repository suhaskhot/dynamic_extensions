 ...
 * @author chetan_patil
 */
public class AttributeInterfaceComparator implements Comparator<AttributeInterface>,Serializable
{

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 6601547271842115655L;
