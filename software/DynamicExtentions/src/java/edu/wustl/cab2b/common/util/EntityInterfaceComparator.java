...
public class EntityInterfaceComparator implements Comparator<EntityInterface>
{
	...
	public int compare(EntityInterface entity1, EntityInterface entity2)
	{
		...
		else if (Utility.isCategory(entity1))
		{ // if first entity is category return it as smaller one
			return -1;
		}
		else if (Utility.isCategory(entity2))
		{ // else return as greater one
			return 1;
		}
		else
		{ //If both the entities are classes then compare their names and return values accordingly
