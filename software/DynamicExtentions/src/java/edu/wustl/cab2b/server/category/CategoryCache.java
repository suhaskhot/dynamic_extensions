...
public class CategoryCache
{
	 ...
	 */
	public static synchronized CategoryCache getInstance() throws DynamicExtensionsCacheException
	{
		if (cache == null)
		{
	...
	private void init() throws DynamicExtensionsCacheException
	{
	...
	private void addCategoryToCache(Category category) throws DynamicExtensionsCacheException
	{
		CategoryOperations categoryOperations = new CategoryOperations();
		categoryVsClasseSet.put(category.getId(), categoryOperations.getAllSourceClasses(category));
		categoryVsAttributeSet.put(category.getId(), categoryOperations
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public void addCategory(Category category) throws DynamicExtensionsCacheException
	{
		addCategoryToCache(category);
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public void refreshCategoryCache() throws DynamicExtensionsCacheException
	{
