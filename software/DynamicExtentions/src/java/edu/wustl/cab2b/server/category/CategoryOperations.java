...
public class CategoryOperations extends DefaultBizLogic
{
	 ...
	 */
	public Category getCategoryByEntityId(Long entityId) throws DynamicExtensionsCacheException
	{
		List list = null;
		try
		{
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public Category getCategoryByCategoryId(Long categoryId) throws DynamicExtensionsCacheException
	{
		List list = null;
		try
		{
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public Set<EntityInterface> getAllSourceClasses(Category category) throws DynamicExtensionsCacheException
	{
	...
	private void postRetrievalProcess(Category category, EntityCache cache) throws DynamicExtensionsCacheException
	{
	...
	private void processCategorialClass(CategorialClass categorialClass, EntityCache cache) throws DynamicExtensionsCacheException
	{
		...
		if (pathId != null && pathId.intValue() != -1)
		{
			...
			categorialClass.setPathFromParent(path);
		}
		...
		for (CategorialAttribute attribute : categorialClass.getCategorialAttributeCollection())
		{
			...
			AttributeInterface attributeOfCategoryEntity = categoryEntity
					.getAttributeByIdentifier(categoryEntityAttributeId);
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public List<EntityInterface> getAllRootCategories() throws DynamicExtensionsCacheException
	{
		List<Object> allCategories = null;
		try
		{
			allCategories = retrieve(Category.class.getName(), null,
					new String[]{"parentCategory"}, new String[]{"is null"}, new Object[0], null);
		}
		catch (BizLogicException e)
		{
		...
		List<EntityInterface> categoryEntities = new ArrayList<EntityInterface>(allCategories
				.size());
		EntityCache cache = EntityCache.getInstance();
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public List<Category> getAllCategories() throws DynamicExtensionsCacheException
	{
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	public Set<AttributeInterface> getAllSourceAttributes(Category category) throws DynamicExtensionsCacheException
	{
	 ...
	 * @throws DynamicExtensionsCacheException
	 */
	private Set<AttributeInterface> getAllChilrenCategorialClasses(CategorialClass catClass) throws DynamicExtensionsCacheException
	{
		EntityCache cache = EntityCache.getInstance();
