...
public class PathRecord
{
	...
	private final long firstEntityId;

	private final String intermediateAssociations;

	private final long lastEntityId;
	 ...
	 */
	public PathRecord(long pathId, long firstEntityId, String intermediateAssociations,
			long lastEntityId)
	{
		this.pathId = pathId;
	...
	{
		String[] associationIds = intermediateAssociations.split(Constants.CONNECTOR);
