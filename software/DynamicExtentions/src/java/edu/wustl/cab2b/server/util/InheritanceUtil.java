...
public final class InheritanceUtil
{
	...
	/**
	 * Instantiates a new inheritance util.
	 */
	...
	public static AssociationInterface getActualAassociation(AssociationInterface association)
	{
		...
		AssociationInterface actualAssociation = EntityCache.getInstance()
				.getAssociationByUniqueStringIdentifier(originalAssociationPointer);
