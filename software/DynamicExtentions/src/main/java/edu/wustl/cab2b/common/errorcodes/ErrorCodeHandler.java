...
/**
 * Class to handle the error codes and the corresponding messages to be shown to
 * the user.
 *
...
public final class ErrorCodeHandler
{
    ...
    /**
     * Instantiates a new error code handler.
     */
    ...
    //
    // /**
    // * This method should be used when you want to customize error message
    // with multiple replacement parameters
    // *
    ...
    // message.replace(message.indexOf("{"), message.indexOf("}") + 1, (String)
    // placeHolders.get(i));
    // }
    ...
    // /**
    // * This method should be used when you want to customize error message
    // with single replacement parameter
    // *
    // * @param theKey - error key
    // * @param placeHolders - replacement Strings
    // * @return - complete error message
    ...
    /**
     * Returns the error message corresponding to the error code passed from the
     * error codes file.
     *
     * @param errorCode
     *            The error code
     * @return the error message corresponding to the error code passed from the
     *         error codes file.
     */
