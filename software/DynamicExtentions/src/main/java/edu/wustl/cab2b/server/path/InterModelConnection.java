...
class InterModelConnection
{
	 ...
	 */
	private final Long leftAttributeId;

	/**
	 * Matching attribute from right side entity.
	 */
	private final Long rightAttributeId;
	...
	private InterModelConnection(Long leftEntityId, Long leftAttributeId, Long rightEntityId,
			Long rightAttributeId)
	{
	...
	{
		return new InterModelConnection(rightEntityId, rightAttributeId, leftEntityId,
				leftAttributeId);
	}
	...
	public boolean equals(Object object)
	{
		...
		else if (!(object instanceof InterModelConnection))
		{
			isEqual = false;
		}
		else
		{
			...
			isEqual = leftEntityId.equals(other.leftEntityId)
					&& leftAttributeId.equals(other.leftAttributeId)
					&& rightEntityId.equals(other.rightEntityId)
					&& rightAttributeId.equals(other.rightAttributeId);
		}
		return isEqual;
	}
	...
	public int hashCode()
	{
		return new HashCodeBuilder().append(leftEntityId).append(leftAttributeId).append(
				rightEntityId).append(rightAttributeId).toHashCode();
	}
}