...
// ===================Update Server State=======================
function updateServerState(controlName, controlId, containerId, formContextId)
{
	if(document.getElementById('isDirty')!=null)
	{
		document.getElementById('isDirty').value = true;
    ...
    request.send(encodeURI("&ajaxOperation=updateServerState&FormContextIdentifier="+formContextId+"&containerId=" + containerId + "&controlId=" + controlId
			+ "&controlValue=" + controlValue + "&controlName=" + controlName));
}
