...
<c:if test="${param.useApplicationStylesheet == 'null' || param.useApplicationStylesheet == null || param.useApplicationStylesheet == 'false'}">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/stylesheets/de/dynamicExtensions.css" />
</c:if>
<c:if test="${param.useApplicationStylesheet == 'true'}">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/catissue_suite.css" />
</c:if>
