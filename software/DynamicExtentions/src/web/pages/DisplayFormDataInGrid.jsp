...
<!-- link rel="stylesheet" type="text/css" href="/clinportal/css/calanderComponent.css" /-->
...
<link rel="STYLESHEET" type="text/css" href="dhtmlxSuite_v35/dhtmlxGrid/codebase/skins/dhtmlxgrid_skins.css"/>
...
<script type="text/javascript" src="dhtmlxSuite_v35/dhtmlxGrid/codebase/ext/dhtmlxgrid_srnd.js"></script>
<script type="text/javascript"  src="dhtmlxSuite_v35/dhtmlxGrid/codebase/ext/dhtmlxgrid_pgn.js"></script>
<script type="text/javascript"  src="dhtmlxSuite_v35/libCompiler/connector.js"></script>
<script type="text/javascript"  src="dhtmlxSuite_v35/dhtmlxGrid/codebase/ext/dhtmlxgrid_splt.js"></script>
...
var header = "#master_checkbox,,,";
		...
		function getDataType(dataType)
		{
			...
			else if(dataType.match("FLOAT") || dataType.match("INTEGER"))
			{
				return "int";
			}
			else
		...
		function doOnLoad()
		{
			...
			formDataGrid.setImagePath("<%=request.getContextPath()%>/dhtmlxSuite_v35/dhtmlxGrid/codebase/imgs/");
