...
<body>
	...
	<div class="content">
		<div id="sm-category">
			...
			<iframe style="display:none" src="about:blank" id="tempIframe" name="tempIframe" onload="">
				<dynamicExtensions:serverStateHtml/>
			</iframe>
			<script type="text/javascript" defer="defer">updateHTML();</script>
		</div>
	</div>
...
<c:if test='${empty sessionScope.formSubmitUrl}'>
	<script>
		document.getElementById('sm-form').action = "${pageContext.request.contextPath}/ApplyDataEntryFormAction.de";
	</script>
</c:if>	
