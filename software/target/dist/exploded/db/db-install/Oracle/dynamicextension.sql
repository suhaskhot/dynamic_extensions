...
create table ABSTRACT_CATEGORIAL_ATTRIBUTE (ID number(19,0) not null, CATEGORIAL_CLASS_ID number(19,0), DE_SOURCE_CLASS_ATTRIBUTE_ID number(19,0), ABSTRACT_CATEGORIAL_ATTRIBUTE_ID number(19,0), primary key (ID));
...
create table DYEXTN_CATEGORY (IDENTIFIER number(19,0) not null, ROOT_CATEGORY_ELEMENT number(19,0), CATEGORY_ENTITY_ID number(19,0), primary key (IDENTIFIER));
...
create table DYEXTN_COMBOBOX (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
...
create table DYEXTN_CONTROL (IDENTIFIER number(19,0) not null, SHOW_LABEL number(1,0), CAPTION varchar2(800 char), IS_CALCULATED number(1,0), CSS_CLASS varchar2(255 char), HIDDEN number(1,0), NAME varchar2(255 char), SEQUENCE_NUMBER number(10,0), TOOLTIP varchar2(255 char), CONTAINER_ID number(19,0), BASE_ABST_ATR_ID number(19,0), READ_ONLY number(1,0), HEADING varchar2(255 char), yPosition number(10,0), primary key (IDENTIFIER));
create table DYEXTN_DATABASE_PROPERTIES (IDENTIFIER number(19,0) not null, NAME varchar2(255 char), primary key (IDENTIFIER));
create table DYEXTN_DATA_ELEMENT (IDENTIFIER number(19,0) not null, CATEGORY_ATTRIBUTE_ID number(19,0), ATTRIBUTE_TYPE_INFO_ID number(19,0), primary key (IDENTIFIER));
create table DYEXTN_DATA_GRID (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
create table DYEXTN_DATEPICKER (IDENTIFIER number(19,0) not null, DATE_VALUE_TYPE varchar2(255 char), primary key (IDENTIFIER));
...
create table DYEXTN_ENTITY_MAP (IDENTIFIER number(19,0) not null, CONTAINER_ID number(19,0), STATUS varchar2(10 char), STATIC_ENTITY_ID number(19,0), CREATED_DATE date, CREATED_BY varchar2(255 char), primary key (IDENTIFIER));
create table DYEXTN_ENTITY_MAP_CONDNS (IDENTIFIER number(19,0) not null, STATIC_RECORD_ID number(19,0), TYPE_ID number(19,0), FORM_CONTEXT_ID number(19,0), primary key (IDENTIFIER));
create table DYEXTN_ENTITY_MAP_RECORD (IDENTIFIER number(19,0) not null, FORM_CONTEXT_ID number(19,0), STATIC_ENTITY_RECORD_ID number(19,0), STATUS varchar2(10 char), DYNAMIC_ENTITY_RECORD_ID number(19,0), MODIFIED_DATE date, CREATED_DATE date, CREATED_BY varchar2(255 char), primary key (IDENTIFIER));
...
create table DYEXTN_FORM_CONTEXT (IDENTIFIER number(19,0) not null, IS_INFINITE_ENTRY number(1,0), ENTITY_MAP_ID number(19,0), STUDY_FORM_LABEL varchar2(255 char), NO_OF_ENTRIES number(10,0), primary key (IDENTIFIER));
...
create table DYEXTN_PERMISSIBLE_VALUE (IDENTIFIER number(19,0) not null, DESCRIPTION varchar2(255 char), CATEGORY_ATTRIBUTE_ID number(19,0), ATTRIBUTE_TYPE_INFO_ID number(19,0), primary key (IDENTIFIER));
