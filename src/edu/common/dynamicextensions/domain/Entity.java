...
public class Entity extends AbstractMetadata implements EntityInterface
{
    ...
    private void setTablePropertiesCollection(
            Collection tablePropertiesColletion)
    {
    ...
    public TablePropertiesInterface getTableProperties()
    {
        ...
        {
            Iterator tabletPropertiesIterator = tablePropertiesCollection
                    .iterator();
     ...
     * 
     */
    public void addAbstractAttribute(
     ...
     * 
     */
    public void removeAbstractAttribute(
            AbstractAttributeInterface abstractAttributeInterface)
    {
        if (abstractAttributeCollection != null)
        {
            if (abstractAttributeCollection
                    .contains(abstractAttributeInterface))
            {
    ...
    /**
     * This method returns the AbstractAttributeInterface for the passed identifier.
     * @param id Identifier of the required attribute
     * @return AbstractAttributeInterface The matched instance of AbstractAttributeInterface.
     */
    public AbstractAttributeInterface getAttributeByIdentifier(Long id)
    {
        ...
        {
            Iterator attributeIterator = this.abstractAttributeCollection
                    .iterator();
            while (attributeIterator.hasNext())
            {
                attribute = (AbstractAttribute) attributeIterator.next();
