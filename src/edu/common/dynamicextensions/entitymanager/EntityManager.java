...
public class EntityManager implements EntityManagerInterface
{
	...
	public void insertData(EntityInterface entity, Map dataValue) throws DynamicExtensionsApplicationException, DynamicExtensionsSystemException
	{
		...
		{
			throw new DynamicExtensionsSystemException("Can not execute query...Session can not be obtained");
		}
		Connection conn;
		try
		{
		...
		{
			throw new DynamicExtensionsSystemException("Cannot execute query... connection can not be obtained");
		}
	 ...
	 * @throws ClassNotFoundException
	 */
	List getResultInList(String queryToGetNextIdentifier, SessionDataBean sessionDataBean, boolean isSecureExecute,
