...
public interface PathConstants
{
	 ...
	 */
	String PATH_FILE_NAME = System.getProperty("user.home") + File.separator + "Paths.txt";

	/**
	 * Represents the location where association file is generated.Used to populate ASSOCIATION table
	 */
	String ASSOCIATION_FILE_NAME = System.getProperty("user.home") + File.separator
			+ "associations.txt";
	 ...
	 */
	String CA_DSR_URL = "http://cagrid04.bmi.ohio-state.edu:7080/wsrf/services/cagrid/CaDSRService";
